...
public class SystemException extends RuntimeException {
   ...
   * @param stream
   *          PrintStream in den der Stacktrace ausgegeben wird.
   */
   ...
   * @param propertyKey
   *          ist der Property-Key fuer den Wert.
   * @param property
   *          ist der Property-Wert.
   * @return
   *          dieses SystemException-Objekt.
   */
