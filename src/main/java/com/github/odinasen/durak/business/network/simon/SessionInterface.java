...
public interface SessionInterface {
     ...
     *
     * @param callable Ist das Remote-Objekt, das den Client referenziert.
     * @param message  Ist die Nachricht, die gesendet wird.
     */
    void sendChatMessage(Callable callable, String message);
     ...
     *
     * @param callable Ist das Remote-Objekt, das den Client referenziert.
     * @param action   Ist die Spielaktion, die ausgefuehrt wird.
     * @return True, wenn die Aktion ausgefuehrt wurde.
     * False, wenn die Aktion gegen Regeln verstoesst und nicht ausgefuehrt wurde.
     */
    boolean doAction(Callable callable, GameAction action);
     ...
     *
     * @param callable Ist das Remote-Objekt, das den Client referenziert.
     * @param client   Ist das Informationsobjekt des Clients.
     */
    void updateClient(Callable callable, ClientDto client);

    /**
     * Liefert das Remote-Objekt der Session.
     */
